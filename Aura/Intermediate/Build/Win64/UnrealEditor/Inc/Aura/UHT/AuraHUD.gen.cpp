...
// End Cross Module References
...
#if !UE_BUILD_SHIPPING
		{ "Comment", "/*UPROPERTY()\n\x09TObjectPtr<UAuraUserWidget> AttributeMenuWidget;\n\n\x09UPROPERTY(EditAnywhere)\n\x09TSubclassOf<UAuraUserWidget> AttributeMenuWidgetClass;*/" },
#endif
		{ "ModuleRelativePath", "Public/UI/HUD/AuraHUD.h" },
#if !UE_BUILD_SHIPPING
	...
	AAuraHUD::~AAuraHUD() {}
	struct Z_CompiledInDeferFile_FID_Users_yelsa_OneDrive_Documents_Unreal_Projects_AuraRepository_Aura_Source_Aura_Public_UI_HUD_AuraHUD_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_yelsa_OneDrive_Documents_Unreal_Projects_AuraRepository_Aura_Source_Aura_Public_UI_HUD_AuraHUD_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AAuraHUD, AAuraHUD::StaticClass, TEXT("AAuraHUD"), &Z_Registration_Info_UClass_AAuraHUD, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AAuraHUD), 186802873U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_yelsa_OneDrive_Documents_Unreal_Projects_AuraRepository_Aura_Source_Aura_Public_UI_HUD_AuraHUD_h_2925362398(TEXT("/Script/Aura"),
		Z_CompiledInDeferFile_FID_Users_yelsa_OneDrive_Documents_Unreal_Projects_AuraRepository_Aura_Source_Aura_Public_UI_HUD_AuraHUD_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_yelsa_OneDrive_Documents_Unreal_Projects_AuraRepository_Aura_Source_Aura_Public_UI_HUD_AuraHUD_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
